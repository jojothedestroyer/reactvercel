...
import bgvid1 from '../assets/videos2/video-2.mp4';
import './Header.css'
const Header = () => {
  return (
    ...
    //  style={{backgroundImage: "url('/header_img.png')"}}
     id='Header'>
              <video className=' z-20' src={bgvid1} autoPlay loop muted />
        ...
        z-30
         text-white'>
            ...
            sm:text-6xl 
            md:text-[82px]
            inline-block max-w-3xl font-semibold pt-20'>We bring you where you need to be</h2>
