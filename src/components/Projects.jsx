...
//     bg-gray-800 rounded-lg shadow-xl text-white ' id='Projects'>
...
//         {/* project slider container below */}
...
const Projects = () => {
  ...
  return (
    ...
    bg-gray-800 rounded-lg shadow-xl text-white m-10'
      id='Projects'
    >
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>
        Below contains an example of A personal project
      </p>
      ...
      <div className='overflow-hidden'>
        ...
        >
          {projectsData.map((project, index) => (
            <div
              key={index}
              className='relative flex-shrink-0 w-full sm:w-1/4 project-card'
              onClick={() => handleCardClick(project.video)}
            >
              <img src={project.image} alt={project.title} className='w-full h-auto mb-14' />
              <div className='absolute left-0 right-0 bottom-5 flex justify-center'>
                <div className='inline-block bg-white w-3/4 px-4 py-2 shadow-md'>
